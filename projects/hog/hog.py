        ...
        if player == 0:
            ...
            if num_rolls == -1:
             ...
             #   print("score0 = ",score0)
                ...
                current_score = take_turn(num_rolls, score1, dice)
           ...
           # player = other(player)
            ...
            if num_rolls == -1:
              ...
              #  print("score1= ",score1)
                ...
                current_score = take_turn(num_rolls, score0, dice)
               # print("current_score= ",current_score)
                score1 += current_score
               # print("score1= " ,score1)
        if score1 and score0:
            if score0 == 2 * score1 or score1  == 2 * score0:
                temp   = score0
                score0 = score1
                score1 = temp
        player = other(player)
       # print("score0= , score1 =", score0 , score1)
    # END PROBLEM 5
...
def check_strategy(strategy, goal=GOAL_SCORE):
    ...
    for i in range(0, goal):
        for j in range(0, goal):
            if strategy(i, j) > 10 or strategy(i,j) < -1:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 8
    aver_dice = make_averaged(roll_dice, num_samples)
    max_score = aver_dice(1, dice)
    num_rolls = 2
    turn = 1
    while num_rolls <= 10:
        if aver_dice(num_rolls, dice) > max_score:
            max_score = aver_dice(num_rolls, dice)
            turn = num_rolls
        num_rolls += 1
    return turn
    # END PROBLEM 8
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if free_bacon(opponent_score) >= margin:
        return 0
    elif is_prime(free_bacon(opponent_score)) and next_prime(free_bacon(opponent_score)) >= margin:
        return 0
    return num_rolls
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if bacon_score >= margin:
        return 0
    elif opponent_score == 2 * (bacon_score + score):
        return 0
    else :
        return num_rolls
    # END PROBLEM 10
